...
let scale_factor = map(drum, 1, height, 1, 10);
let cellSize = 250;
let colourScheme = 1
...
let from = color(255,26,0);
let to = color(227,255,0);
// let pct = map(cx, scale_factor, width-scale_factor, 0.1);
let pct = map(bass, 0, 100, 0, 1);
